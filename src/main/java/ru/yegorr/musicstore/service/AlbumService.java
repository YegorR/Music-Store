...
public interface AlbumService {
    FullAlbumDto createAlbum(CreateAlbumDto createAlbumRequest, Long musicianId) throws ClientException;

    FullAlbumDto changeAlbum(ChangeAlbumDto changeAlbumRequest, Long albumId) throws ClientException;
