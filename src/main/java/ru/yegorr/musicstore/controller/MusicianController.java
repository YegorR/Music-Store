...
import ru.yegorr.musicstore.dto.request.CreateMusicianDto;
...
public class MusicianController {
  ...
  public ResponseEntity<?> createMusician(@RequestBody CreateMusicianDto createMusicianDto,
    ...
    MusicianDto musicianResponseDto =
            musicianService.createMusician(createMusicianDto.getName(), createMusicianDto.
                    getDescription());

    return ResponseBuilder.getBuilder().code(HttpStatus.CREATED).body(musicianResponseDto).
            getResponseEntity();
  }

  @PutMapping("/musician/{musicianId}")
  public ResponseEntity<?> changeMusician(@RequestBody CreateMusicianDto createMusicianDto,
    ...
    return ResponseBuilder.getBuilder().body(musicianResponseDto).code(HttpStatus.OK).
            getResponseEntity();
  ...
  public ResponseEntity<?> getMusiciansAbcList(@RequestHeader("Authorization") String token)
          throws Exception {
    userChecker.checkAdmin(token);
  ...
  public ResponseEntity<?> loadImage(@PathVariable Long musicianId,
                                     @RequestHeader("Authorization") String token,
